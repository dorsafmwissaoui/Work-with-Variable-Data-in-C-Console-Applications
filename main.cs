  ...
  static void Main(){
   ...
   /* //Task 1
    ...
    do
    {
        ...
        {
            Console.WriteLine("Sorry, you entered a non-numeric value. Please enter a valid number.");
        }
    } while (!validEntry);
    ...
    do
    {
        ...
        if (readResult != null)
        {
            string str = readResult.ToLower().Trim();
            if (str == "administrator" || str == "manager" || str == "user")
            {
                validEntry = true;
            }
            else
